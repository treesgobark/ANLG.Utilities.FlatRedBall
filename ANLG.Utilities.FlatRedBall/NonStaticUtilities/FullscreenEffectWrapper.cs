...
public class FullscreenEffectWrapper
{
    ...
    public virtual void SetVertexData(Camera camera, VertexPositionColorNormalTexture[] vertices, float zDepth)
    {
        ...
        vertices[0].Position = TopRight.Scale(gameScreenWidth, gameScreenHeight); // Top-Right
        vertices[1].Position = BottomRight.Scale(gameScreenWidth, gameScreenHeight);; // Bottom-Right
        vertices[2].Position = TopLeft.Scale(gameScreenWidth, gameScreenHeight);; // Top-Left
        vertices[3].Position = BottomLeft.Scale(gameScreenWidth, gameScreenHeight);; // Bottom-Left
